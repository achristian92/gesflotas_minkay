		...
		<div >
                  ...
                  <div id="modnvdepcar" class="modal fade" role="dialog">
					    <div class="modal-dialog">
						    ...
						    <div class="modal-header">
						        ...
						        <h3 class="modal-title"> Nuevo departamento a cargo </h3>
						    </div>
						    <div class="modal-body">
							  <form class="form-horizontal">
						
								<div class="form-group">
								  <label class="col-md-6 control-label" for="textinput">Nombre departamento a cargo</label>  
									  <div class="col-md-5">
				...
				<table class="table table-striped">
	              ...
	              @foreach ($datos as $datoc)
	                	<tr>
	                		<td>
	                		{{ $datoc->iddepartamento_cargo }}
	                		</td>
	                		<td>
	                		{{ $datoc->nombre_depar_cargo }}
	                		</td>
	                		<td>
